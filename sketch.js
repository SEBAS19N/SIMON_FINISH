...
function setup(){ //crear sprites, configurar 
 ...
 textScore = createElement('h3', 'score: '+ score);
 textScore.position(width-200, 30);
 //textScore.setAttribute('id','text');
 //text.id=score
...
buttomReset.visible = false
    ...
    score += Math.round(getFrameRate()/75);
